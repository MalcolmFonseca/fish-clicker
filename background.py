...
class Background():
    def __init__(self):
        self.image = None
        self.background_images = [pygame.image.load('Assets/backgrounds/background.png').convert(),
    ...
    def render(self):
        ...
        if util.player_ob.kills < 10_000:
            ...
            self.image = self.background_images[3]
        elif util.player_ob.kills < 50_000:
            self.image = self.background_images[4]
        else:
            self.image = self.background_images[5]
