...
class MainMenu(Menu):
    def __init__(self):
        ...
        self.font = pygame.font.Font('Assets/Kamalla.ttf',math.trunc(util.window_size[1]/16.6))
        ...
        #options button
        self.options_button_rect = pygame.Rect(0,0,(util.window_size[0]/6)-util.window_size[0]/32,util.window_size[1]/16)
